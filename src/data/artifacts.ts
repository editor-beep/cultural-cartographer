...
const CURATED: Artifact[] = [
  ...
  {
    slug: "the-catcher-in-the-rye-jd-salinger",
    ...
    medium: "book",
    catalogue: "ARTX-201",
    epigraph: "Anyway, I keep picturing all these little kids playing some game in this big field of rye and all.",
    reading:
      "Approaching three-quarters of a century in the public consciousness, *The Catcher in the Rye* occupies a deeply paradoxical space in literary registries: it has mutated from a volatile, institutional contaminant banned by school boards into a mandatory, state-sanctioned piece of adolescent curriculum. The cultural discourse around Holden Caulfield is defined by an ongoing generational whiplash. The text's linguistic footprint across digital networks reveals an active, rolling conflict. For younger cohorts experiencing algorithmic isolation, Caulfield's hyper-fixation on 'phoniness' is read as an urgent, proto-internet scream against structural authenticity deficits. Conversely, an equally vocal faction of post-ironic readers registers the text with heavy exhaustion, treating Caulfield not as an avatar of pure alienation, but as the foundational archetype of white, male, bourgeois entitlement. Because the text is so fiercely protected by its late author's estate—blocking any potential cinematic or multimedia translation—its linguistic purity remains intact, existing solely as a psychic mirror for the transition out of childhood.",
    metrics: {
      consensus: 64,
      friction: 79,
      obsession: 92,
    ...
    notes: {
      consensus: "Moderate consensus. While universally anthologized, public reading is deeply split: it is either a masterwork of profound psychological vulnerability or a tedious ledger of teenage whining.",
      friction: "High durable friction. The interpretive war over Holden's character—victim of grief versus insufferable narcissist—remains an active, daily micro-conflict across literary platforms.",
      haunting: "Intense linguistic markers of intrusive memory. The text's historical, non-authorized intersection with real-world violence (specifically the assassination of John Lennon) inflicts a persistent, historical unease onto the registry.",
      accessibility: "Exceptionally high accessibility. Salinger's colloquial, rhythmic prose requires zero context or glossary to entry, making its barrier to access virtually nonexistent.",
    },
    afterlife: [
      { year: 1951, kind: "release", label: "Original publication by Little, Brown and Company, igniting immediate commercial success and fierce moral panic." },
      { year: 1960, kind: "rejection", label: "Widespread institutional ban campaigns across American public school districts due to vulgarity and blasphemy." },
      { year: 1980, kind: "wound", label: "The shooting of John Lennon by Mark David Chapman permanently hitches the text to real-world psychological derailment." },
      { year: 2010, kind: "wound", label: "The death of J.D. Salinger triggers massive archival post-mortems regarding his extreme reclusion and textual control." },
      { year: 2019, kind: "academic", label: "The opening of Salinger's literal archives prompts a wave of critical reappraisals tracking his WWII trauma through Holden's voice." },
    ],
    factions: [
      { name: "The Trauma Materialists", share: 0.45, voice: "“Holden isn’t an annoying brat; he is a deeply traumatized child frozen by intense grief over his brother’s death, navigating a cold world completely devoid of genuine adult empathy.”" },
      { name: "The Post-Ironic Skeptics", share: 0.35, voice: "“An incredibly dated monument to privileged, solipsistic angst. It’s difficult to read his relentless complaining with any real gravity in a hyper-crisis era.”" },
      { name: "The Structural Preservationists", share: 0.20, voice: "“The absolute peak of the American conversational vernacular. Salinger captured the precise, tragic rhythm of the mid-century teenage mind before the monoculture flattened it.”" },
    ],
    symbols: ["a red hunting hat", "ducks in a frozen Central Park lagoon", "a scratched carrousel brass ring", "glowing museum glass cases", "unwritten letters to Phoebe"],
    pos: { x: -0.34, y: 0.68 },
  },
  {
    slug: "naked-lunch-william-s-burroughs",
    title: "Naked Lunch",
    year: 1959,
    director: "William S. Burroughs",
    runtime: 282,
    medium: "book",
    catalogue: "ARTX-202",
    epigraph: "A frozen moment when everyone sees what is on the end of every fork.",
    reading:
      "Decades after surviving the final major obscenity trial in American literary history, *Naked Lunch* operates as a sprawling, highly toxic geopolitical engine within the avant-garde registry. The text has completely resisted any attempts at mainstream gentrification. It exists not as a narrative story, but as a modular, chaotic software system built via the 'cut-up' method—a paranoid blueprint detailing state control, biological addiction, and corporate surveillance. The current online registry indicates a highly specialized mention volume: it is tracked predominantly within post-structuralist academic cells, industrial countercultures, and digital privacy communities who treat its depiction of 'Interzone' as a literal, prophetic forecast of our hyper-surveilled, bio-political internet infrastructure. Its prose remains violently abrasive, generating a persistent physiological disgust that insulates it from casual, nostalgic consumption.",
    metrics: {
      consensus: 48,
      friction: 82,
      obsession: 89,
    ...
    notes: {
      consensus: "Low consensus because traditional narrative critique cannot compute it; it remains split between being hailed as a brilliant, prophetic masterpiece of anti-capitalist satire or dismissed as an unreadable, drug-addled pile of pure filth.",
      formal: "Near maximum formal risk. The total abandonment of linear plot, the physical cutting and pasting of pages, and the fluid, shifting identities of its characters represent an absolute refusal of the traditional novel shape.",
      voltage: "Extreme physical and biological voltage. Discussion language across registries is explicitly visceral, tracking reactions of deep nausea, claustrophobia, panic, and bodily violation.",
      accessibility: "Hostile. The text demands an immense tolerance for structural fragmentation, body horror, and extreme graphic transgression. Arriving without a glossary of the Beat avant-garde or addiction terminology is completely fatal to comprehension.",
    },
    afterlife: [
      { year: 1959, kind: "release", label: "Published by Olympia Press in Paris after massive rejections from mainstream American publishing houses." },
      { year: 1962, kind: "rejection", label: "The book is banned by Boston courts for obscenity, triggering a high-profile legal defense by prominent literary figures." },
      { year: 1966, kind: "rediscovery", label: "The Massachusetts Supreme Judicial Court declares the book not obscene, marking the definitive legal collapse of American literary censorship." },
      { year: 1991, kind: "release", label: "David Cronenberg’s meta-textual cinematic adaptation introduces the book’s creation mythology to a wider cinematic audience." },
      { year: 2022, kind: "academic", label: "Scholarly journals hyper-focus on the text’s ‘Algebra of Need’ concept as an eerily accurate framework for algorithmic dopamine addiction." },
    ],
    factions: [
      { name: "The Paranoid Cyber-Analysts", share: 0.50, voice: "“It’s a terrifyingly accurate prophetic document. Burroughs didn’t just write about junk; he mapped how modern tech platforms use addiction, surveillance, and bio-control to completely dominate human agency.”" },
      { name: "The Counter-Cultural Loyalists", share: 0.30, voice: "“The absolute, ultimate transgressive text. A hilarious, disgusting, and completely radical explosion of language that permanently broke the boundaries of what literature was allowed to look like.”" },
      { name: "The Narrative Traditionalists", share: 0.20, voice: "“An completely unreadable, self-indulgent exercise in shock value. The cut-up method completely destroys any chance of emotional resonance or coherent thematic development.”" },
    ],
    symbols: ["a giant black centipede", "the Mugwump fluid", "a rusty hypodermic needle", "the Interzone marketplace", "a typewriter mutating into an insect"],
    pos: { x: -0.91, y: 0.88 },
  },
  {
    slug: "the-bell-jar-sylvia-plath",
    title: "The Bell Jar",
    year: 1963,
    director: "Sylvia Plath",
    runtime: 244,
    medium: "book",
    catalogue: "ARTX-203",
    epigraph: "To the person in the bell jar, blank and stopped as a dead baby, the world itself is the bad dream.",
    reading:
      "Sixty years after its pseudonymous deployment, *The Bell Jar* exists in a state of permanent, high-intensity cultural haunting. The text is completely unique within the biographical registry: its reception history is forever tethered to the tragic, real-world suicide of Plath just weeks after its UK release, creating a hyper-permeable membrane between the text and the author's literal ghost. In contemporary digital landscapes, the book has experienced a massive, algorithmic mutation. It has been heavily absorbed into modern mental health communities and short-form video registries, where its description of Esther Greenwood's paralyzing depression—most notably the iconic fig tree metaphor—is treated as the ultimate, definitive vocabulary for modern female burnout, capitalist alienation, and choices paralysis. The discourse remains highly defensive, fiercely guarding the text against older patriarchal readings that historically attempted to clinicalize or dismiss its rage as mere private hysteria.",
    metrics: {
      consensus: 78,
      friction: 42,
      obsession: 95,
    ...
    notes: {
      consensus: "High consensus regarding its canonical genius, following decades of institutional work to rescue it from being treated merely as a tragic biographical curiosity.",
      haunting: "Near absolute maximum. The linguistic register is saturated with language of extreme unease, intrusive memory, and somatic empathy. Viewers talk about the prose 'installing' a physical, suffocating heavy air in their rooms.",
      voltage: "Extremely high physiological voltage. Plath’s clean, razor-sharp, and unsparingly clinical descriptions of electroshock therapy, suicide attempts, and catatonic depression provoke immediate bodily reactions from modern audiences.",
      accessibility: "Highly accessible. The prose is beautifully clear, sharp, and deceptively modern, allowing readers to enter Esther’s internal world with zero historical friction.",
    },
    afterlife: [
      { year: 1963, kind: "release", label: "Published in the UK under the pseudonym Victoria Lucas; Sylvia Plath commits suicide one month later." },
      { year: 1971, kind: "release", label: "First official US publication under Plath’s real name, despite her family’s intense objections, becoming an instant bestseller." },
      { year: 1982, kind: "criterion", label: "Plath is posthumously awarded the Pulitzer Prize, cementing her work’s total institutional and canonical ascension." },
      { year: 2013, kind: "wound", label: "The 50th-anniversary cover art causes a major public controversy for depicting a woman applying makeup, criticized for trivializing depression as chick-lit." },
      { year: 2024, kind: "meme", label: "The ‘Fig Tree’ passage goes viral on TikTok, mutating into an omnipotent digital shorthand for mid-twenties choice paralysis and existential dread." },
    ],
    factions: [
      { name: "The Political Materialists", share: 0.55, voice: "“It’s not just a book about depression; it’s a brilliant, furious indictment of the claustrophobic, patriarchal cages of 1950s America that actively drove intelligent women mad.”" },
      { name: "The Algorithmic Romantics", share: 0.25, voice: "“The absolute, ultimate articulation of internal sadness and isolation. It perfectly captures what it feels like to watch life pass you by while paralyzed under a glass jar.”" },
      { name: "The Biographical Purists", share: 0.20, voice: "“The text cannot and should not be separated from her journals and poetry. It is a terrifyingly lucid, literal suicide note that documents the chemical unraveling of a brilliant mind.”" },
    ],
    symbols: ["a rotting, dropping fig tree", "a heavy glass bell jar", "the hot, sulfurous New York air", "a silver lipstick case", "the rhythmic hum of an electroshock machine"],
    pos: { x: 0.42, y: 0.96 },
  },
  {
    slug: "fun-home-alison-bechdel",
    title: "Fun Home: A Family Tragicomic",
    year: 2006,
    director: "Alison Bechdel",
    runtime: 232,
    medium: "book",
    catalogue: "ARTX-204",
    epigraph: "He was a virtuoso of looking like he had a reason for everything.",
    reading:
      "Entering its third decade of discourse, *Fun Home* stands as the definitive modern monument to the graphic novel's total entry into prestige literary canonicity. The text functions as a hyper-curated, cryptographic grid where Bechdel maps her own queer awakening directly against her closeted, hyper-obsessive father's hidden life and sudden suicide. The online registry tracks a highly polarized contemporary arc. Within institutional and academic spaces, it is universally revered as a masterpiece of structural architecture, routinely assigned to untangle complex systems of familial grief, queer theory, and literary allusion (Gide, Wilde, Joyce). However, it remains a primary flashpoint in the contemporary American culture wars. It registers an incredibly high current friction score, driven entirely by localized school board purges and conservative legal challenges targeting its explicit illustrated depictions of queer sexuality—transforming a deeply insular memoir about archival family secrets into an involuntary, highly public political battleground.",
    metrics: {
      consensus: 82,
      friction: 86,
      obsession: 78,
    ...
    notes: {
      consensus: "High institutional consensus. Critics, academics, and literary registries are overwhelmingly aligned on its complex structural brilliance, even as political factions attempt to legally suppress it.",
      friction: "Remarkably high, durable friction. Unlike many 2000s indie texts that have settled, *Fun Home* remains an active battleground in real-time legislative disputes over book banning and free speech.",
      symbolic: "Insanely dense. The text operates as an intricate, self-referential maze. Bechdel tracks visual motifs, architectural blueprints, dictionary definitions, and literary parallels across panels with obsessive precision.",
      formal: "High formal risk. It completely upended the graphic medium by combining hyper-rigorous, archival research methods, multi-layered literary prose, and cartooning to create a completely new shape for memoir.",
    },
    afterlife: [
      { year: 2006, kind: "release", label: "Published by Houghton Mifflin, achieving massive mainstream critical acclaim and landing on the New York Times bestseller list." },
      { year: 2013, kind: "release", label: "The musical theater adaptation opens Off-Broadway, eventually moving to Broadway and winning five Tony Awards, expanding its reach into the cultural mainstream." },
      { year: 2014, kind: "academic", label: "The book is selected as mandatory freshman reading at major universities, triggering intense student free-speech and religious objections." },
      { year: 2022, kind: "wound", label: "A massive, coordinated resurgence of school board bans places the book at the absolute center of national anti-LGBTQ+ legislative battles." },
      { year: 2025, kind: "criterion", label: "A prestige, multi-layered archival digital restoration and critical edition solidify its status as a permanent classic of American literature." },
    ],
    factions: [
      { name: "The Institutional Academics", share: 0.50, voice: "“An absolute triumph of structural memoir. Bechdel uses the graphic medium with unprecedented genius, creating a complex, literary puzzle box that masterfully unpacks generational trauma and queer identity.”" },
      { name: "The Culture-War Censors", share: 0.35, voice: "“This book is highly inappropriate, explicit pornography being pushed onto minors under the guise of prestige literature. It must be completely removed from public school libraries.”" },
      { name: "The Comic Traditionalists", share: 0.15, voice: "“A brilliant, historic bridge. It proved to the stuffy literary establishment once and for all that panels and speech bubbles could handle the dense psychological weight of a Joyce novel.”" },
    ],
    symbols: ["a perfectly restored Victorian house", "the Bechdel Funeral Home sign", "a copy of A Portrait of the Artist as a Young Man", "a jar of floor wax", "the cold waters of the Lehigh River"],
    pos: { x: 0.65, y: -0.28 },
  },
];
