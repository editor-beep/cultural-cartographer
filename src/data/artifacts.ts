...
const CURATED: Artifact[] = [
...

  {
    ...
    runtime: 161,
    catalogue: "ARTX-038",
    epigraph: "Wait, I'm not ready to leave yet.",
    reading:
      "Enter the Void exists as a massive, neon-drenched technical provocation that has transitioned from a polarizing festival 'event' to a permanent fixture in the 'transcendental-sordid' canon. Its mention density is characterized by high physiological recall; viewers discuss it not as a narrative, but as a sensory trauma or a chemical event. While the Consensus has settled on its technical brilliance, Friction remains high regarding its philosophical depth versus its adolescent nihilism. It is a cornerstone of the POV evolution, haunting digital spaces through its ubiquitous influence on music video aesthetics and drug-culture visual shorthand.",
    metrics: {
      consensus: 42,
      friction: 78,
      obsession: 65,
    ...
    notes: {
      consensus: "Low consensus driven by the Masterpiece vs. Juvenile Trash divide that has never resolved.",
      haunting: "Scores exceptionally high due to the DMT sequence and the persistent uninvited mental replay of the overhead tracking shots.",
      formal: "Near-ceiling score for its commitment to the first-person spirit-POV and seamless stitching.",
      accessibility: "Penalty for extreme length, flashing lights (medical warnings), and aggressive subject matter.",
    },
    afterlife: [
      { year: 2009, kind: "release", label: "Cannes premiere leads to walkouts and immediate notoriety." },
      { year: 2010, kind: "rejection", label: "Mainstream critics dismiss it as an empty technical exercise." },
      { year: 2014, kind: "academic", label: "Becomes a primary text for studies in Haptic Visuality and Post-Phenomenology." },
      { year: 2018, kind: "meme", label: "The opening credits sequence becomes a permanent aesthetic template for internet culture." },
      { year: 2022, kind: "reissue", label: "Widespread 4K restoration cements its status as a visual benchmark." },
    ],
    factions: [
      { name: "The Psychonauts", share: 0.45, voice: "“The only film that actually captures the geometry of an altered state; a literal religious experience.”" },
      { name: "The Formalists", share: 0.30, voice: "“Ignore the script; the technical achievement in cinematography and stitching changed what is possible in the frame.”" },
      { name: "The Skeptics", share: 0.25, voice: "“A flashy, overlong screensaver for a nihilistic teenager's bedroom.”" },
    ],
    symbols: ["neon signage", "the Tibetan Book of the Dead", "microscopic cellular life", "aerial Tokyo", "the hotel mirror"],
    pos: { x: 0.12, y: 0.88 },
  },
  {
    slug: "climax-2018",
    ...
    reading:
      "If Enter the Void is a trip, Climax is a crash. Its cultural footprint is defined by physiological discussion; it is the go-to reference for anxiety-cinema. Unlike Noé's earlier work, Climax has a surprisingly high Consensus for a transgression-heavy film, largely due to its undeniable craft and the kineticism of its first half. It has become a staple of Best of the Decade lists, moving from the fringe of extreme cinema to a centered example of high-concept horror.",
    metrics: {
      consensus: 68,
      friction: 45,
      obsession: 52,
    ...
    notes: {
      voltage: "Peaked at near-maximum. The bad trip structure is designed to induce physical distress.",
      arc: "High arc score reflects the rapid shift from 'unwatchable' at Cannes to 'essential' in the 2020s streaming era.",
      accessibility: "Actually higher than Void; the dance-film framework provides a recognizable hook for the first 30 minutes.",
    },
    afterlife: [
      { year: 2018, kind: "release", label: "Premiered at Quinzaine; hailed as a return to form for Noé." },
      { year: 2019, kind: "meme", label: "The sangria sequence and opening dance number proliferate on TikTok and Film Twitter." },
      { year: 2021, kind: "academic", label: "Frequent inclusion in studies regarding the New French Extremity and dance on film." },
    ],
    factions: [
      { name: "The Choreographers", share: 0.50, voice: "“A masterpiece of blocking and spatial awareness; a pure dance film that happens to be a nightmare.”" },
      { name: "The Thrill-Seekers", share: 0.30, voice: "“The ultimate party movie that goes horribly wrong. It's a 90-minute panic attack.”" },
      { name: "The Moralists", share: 0.20, voice: "“Irresponsible and cruel for the sake of it; the inclusion of the child character is an unforgivable transgression.”" },
    ],
    symbols: ["the spiked sangria", "the French flag", "the green hair", "the vinyl record", "the locked door"],
    pos: { x: 0.25, y: 0.95 },
  },
...

  {
    ...
    reading:
      "A rare cover version that managed to create its own separate cult. Guadagnino's Suspiria exists in high Friction with Argento's original; it replaces primary-color surrealism with Berlin-grey historical trauma. It has a massive Residual Haunting score, specifically tied to its body-horror sequences that viewers describe as visceral and unforgettable. Dense with symbolic weight — feminism, the Baader-Meinhof Group, dance as a literal weapon — it is currently in a Reclamation Arc where its initially lukewarm box office is being overwritten by intense fan devotion.",
    metrics: {
      consensus: 51,
      friction: 84,
      obsession: 71,
    ...
    notes: {
      friction: "The gap between Arthouse Masterpiece and Pretentious Remake remains wide open.",
      haunting: "The Volk dance sequence and the Olga contortion are cited as intrusive memories by a high percentage of viewers.",
      cult: "The fan-base (especially in online subcultures) is significantly more devoted than the general audience score suggests.",
    },
    afterlife: [
      { year: 2018, kind: "release", label: "Divided critics at Venice; some call it the film of the year, others call it a mess." },
      { year: 2020, kind: "meme", label: "Tilda Swinton's triple role and the prosthetics secret becomes a major talking point." },
      { year: 2023, kind: "rediscovery", label: "Becomes a modern horror classic on social media, with fans dissecting the Mother Markos mythology." },
    ],
    factions: [
      { name: "The Revisionists", share: 0.40, voice: "“Superior to the original; it actually gives the story a soul and a historical weight.”" },
      { name: "The Purists", share: 0.35, voice: "“Too long, too grey, and it tries to do too much. Argento was about the eyes; this is about the brain.”" },
      { name: "The Body-Horror Nerds", share: 0.25, voice: "“That dance-torture scene is the most effective piece of gore in the last 20 years.”" },
    ],
    symbols: ["the hook", "the Berlin Wall", "red yarn", "the three mothers", "the glasses"],
    pos: { x: 0.30, y: 0.65 },
  },
...

  {
    ...
    runtime: 115,
    catalogue: "ARTX-020",
    epigraph: "For the beauty of the gesture.",
    reading:
      "Holy Motors is the ultimate critic's darling that bypassed the usual rejection phase, entering the canon almost immediately as a eulogy for 20th-century cinema. It possesses a unique spectral quality — it is discussed as a dream or a series of masks rather than a plot. While its Accessibility is low, its Symbolic Density is off the charts, serving as a Rorschach test for the viewer's feelings on technology, acting, and death. It is the film that proved the Weird could still command a major cultural conversation.",
    metrics: {
      consensus: 72,
      friction: 32,
      obsession: 79,
    ...
    notes: {
      formal: "The structure is radically episodic, refusing to return to a base reality, scoring high on risk.",
      symbolic: "Every segment acts as a different filmic genre or theory, inviting endless motif-tracking.",
      friction: "Surprisingly low. Most agree it is a work of genius, even if they don't enjoy the experience.",
    },
    afterlife: [
      { year: 2012, kind: "release", label: "Shocked Cannes; Denis Lavant's snub for Best Actor becomes a minor wound in awards history." },
      { year: 2016, kind: "academic", label: "Standard text for Post-Cinema theory and the death of celluloid." },
      { year: 2021, kind: "reissue", label: "10-year retrospectives solidify it as the definitive arthouse film of the 2010s." },
    ],
    factions: [
      { name: "The Cinephiles", share: 0.65, voice: "“A love letter to the medium; it captures the exhaustion of being an actor in an increasingly digital world.”" },
      { name: "The Confused", share: 0.25, voice: "“Why is he a lizard-man in the sewer now? What happened to the limo?”" },
      { name: "The Lavant Loyalists", share: 0.10, voice: "“The greatest physical performance in the history of the camera.”" },
    ],
    symbols: ["the white limousine", "the motion-capture suit", "flowers", "the accordion", "the talking chimps"],
    pos: { x: 0.05, y: 0.70 },
  },
...

  {
    ...
    runtime: 142,
    catalogue: "ARTX-019",
    epigraph: "Peace is a gift you give yourself.",
    reading:
      "Silent Light is a ghost in the machine of modern cinema. Set in a Mennonite community in Mexico, it operates on a temporal frequency so slow it borders on the liturgical. Its cultural footprint is small but extremely deep; it is discussed primarily as a miracle of Transcendental Style. The film's high Formal Risk comes from its audacity to reproduce the ending of Dreyer's Ordet, a move that created significant Friction among cinephiles — was it a tribute or a theft? It remains a benchmark for Slow Cinema that achieves a genuine, unforced Voltage through silence.",
    metrics: {
      consensus: 58,
      friction: 39,
      obsession: 48,
    ...
    notes: {
      accessibility: "Extremely low. The use of Plautdietsch and the glacial pace act as a natural barrier to the uninitiated.",
      haunting: "The opening and closing sunrise/sunset time-lapses are frequently cited as transcendental mental loops.",
      formal: "The film's refusal of artifice and its reliance on non-professional actors creates a hyper-realist risk.",
    },
    afterlife: [
      { year: 2007, kind: "release", label: "Jury Prize at Cannes; Reygadas cemented as a polarizing visionary." },
      { year: 2012, kind: "academic", label: "Becomes a cornerstone of Global Slow Cinema syllabi." },
      { year: 2019, kind: "criterion", label: "Criterion Collection release brings a second wave of American viewership." },
    ],
    factions: [
      { name: "The Transcendentalists", share: 0.60, voice: "“A spiritual awakening; Reygadas captures the divine in the mundane.”" },
      { name: "The Skeptics", share: 0.30, voice: "“Watching paint dry is more kinetic; it's an exercise in directorial ego and slow-motion cosplay.”" },
      { name: "The Dreyer Purists", share: 0.10, voice: "“He didn't just borrow the ending of Ordet; he committed a beautiful heist.”" },
    ],
    symbols: ["the clock on the wall", "the sunrise", "the pickup truck", "the Jacques Brel song", "the tears of a man"],
    pos: { x: 0.02, y: 0.35 },
  },
...

  {
    ...
    runtime: 114,
    catalogue: "ARTX-021",
    epigraph: "Facing the jungle, the hills and the vales, my past lives like ghosts rise up before me.",
    reading:
      "Uncle Boonmee is the ultimate Residual Haunting artifact. It doesn't follow narrative logic; it follows dream logic. Its win of the Palme d'Or in 2010 remains a Friction point in festival history — a moment where the avant-garde fully breached the walls of the establishment. The film is less watched and more absorbed; it has a high Symbolic Density because it treats ghosts, monkeys with glowing red eyes, and catfish as mundane reality. It is a work of deep Obsession for those interested in the porousness of life and death.",
    metrics: {
      consensus: 46,
      friction: 52,
      obsession: 84,
    ...
    notes: {
      haunting: "Near-maximum. The image of the Ghost Monkey is an indelible cultural phantom.",
      symbolic: "The film functions as a nested system of folklore, political history, and reincarnation theory.",
      accessibility: "Total lack of traditional exposition makes it inaccessible to those seeking a standard story.",
    },
    afterlife: [
      { year: 2010, kind: "release", label: "Tim Burton-led jury awards it the Palme d'Or, shocking the industry." },
      { year: 2015, kind: "academic", label: "Key text for Animist Cinema and Southeast Asian political subtext." },
      { year: 2024, kind: "rediscovery", label: "Continuously ranked in Greatest Films polls, defying its difficult reputation." },
    ],
    factions: [
      { name: "The Animists", share: 0.55, voice: "“It's not a movie; it's a doorway to a different state of being.”" },
      { name: "The Frustrated", share: 0.35, voice: "“I fell asleep three times. It's a beautiful screensaver with no internal engine.”" },
      { name: "The Historians", share: 0.10, voice: "“You're missing the point if you don't see the allegory for the Thai military's violent past.”" },
    ],
    symbols: ["the glowing red eyes", "the catfish", "the dinner table", "the cave", "the photograph"],
    pos: { x: 0.08, y: 0.50 },
  },
...

  {
    ...
    runtime: 117,
    catalogue: "ARTX-023",
    epigraph: "War crimes are defined by the winners. I am a winner.",
    reading:
      "The Act of Killing is a Transgression peak. By asking génocidaires to reenact their crimes in the style of their favorite movie genres, Oppenheimer created a feedback loop of horror and kitsch that broke the documentary format. Its Voltage is almost unbearable; it moves bodies through literal nausea. It has no Consensus because it forces the viewer to confront the banality of evil through surrealism — a combination that still creates massive Friction regarding the ethics of its production.",
    metrics: {
      consensus: 54,
      friction: 88,
      obsession: 73,
    ...
    notes: {
      transgression: "The ceiling. There is no other film that forces the perpetrators of mass murder to play cowboys and Indians with their own history.",
      voltage: "Maximum physiological impact. Scrapers show a high volume of keywords like 'sick,' 'vomit,' 'shaking,' and 'nightmare.'",
      formal: "Redefines the documentary as a performative intervention rather than an observation.",
    },
    afterlife: [
      { year: 2012, kind: "release", label: "Telluride and Toronto premieres leave audiences in stunned silence." },
      { year: 2014, kind: "wound", label: "Oscar nomination brings the 1965 Indonesian massacres to global mainstream attention." },
      { year: 2017, kind: "academic", label: "Becomes the primary case study for ethics in documentary filmmaking." },
    ],
    factions: [
      { name: "The Moral Abolitionists", share: 0.45, voice: "“The most important documentary ever made; it uses the killers' own vanity to destroy them.”" },
      { name: "The Ethicists", share: 0.35, voice: "“Exploitative. By giving these monsters a stage, Oppenheimer becomes a collaborator in their narcissism.”" },
      { name: "The Traumatized", share: 0.20, voice: "“I can never unsee this. It has fundamentally changed how I view human nature.”" },
    ],
    symbols: ["the wire garrote", "the giant fish", "the makeup chair", "the dancing girls", "the dry heave"],
    pos: { x: 0.45, y: 0.98 },
  },

  // ── The Rejectionists & Trash-Canon ──────────────────────────────────────

  {
    ...
    runtime: 99,
    catalogue: "ARTX-034",
    epigraph: "Anyway, how's your sex life?",
    reading:
      "The Room is the Big Bang of the modern anti-canon. It functions as a cinematic black hole where traditional metrics of quality vanish. Its cultural life is entirely diaristic and performative; it is no longer a movie, but a ritualistic script for midnight screenings. Its high Friction score comes from the ongoing debate: is it a sincere expression of a singular, fractured ego, or a calculated piece of outsider art? Its Obsession score is fueled by the mystery of its financing and the inscrutable nature of its creator.",
    metrics: {
      consensus: 88,
      friction: 72,
      obsession: 94,
    ...
    notes: {
      cult: "The absolute ceiling. The film's entire existence is now sustained by its devoted, participatory audience.",
      formal: "The low score reflects a total failure of standard form, which ironically becomes the film's primary attraction.",
      arc: "Maximum delta between the 2003 total failure and the 2026 cultural landmark.",
    },
    afterlife: [
      { year: 2003, kind: "release", label: "Two-week run in LA; grossed $1,800. Becomes an immediate joke." },
      { year: 2008, kind: "rediscovery", label: "Midnight screenings turn into a national phenomenon with specific audience cues." },
      { year: 2013, kind: "academic", label: "Greg Sestero publishes The Disaster Artist, legitimizing the film's history." },
      { year: 2017, kind: "meme", label: "James Franco film brings the Wiseau-mythos to the Oscars." },
    ],
    factions: [
      { name: "The Ritualists", share: 0.70, voice: "“Don't watch it alone; the movie is just a backdrop for the spoons and the yelling.”" },
      { name: "The Auteurs of Failure", share: 0.20, voice: "“Wiseau is a genuine surrealist whose lack of skill accidentally captured the human condition.”" },
      { name: "The Exhausted", share: 0.10, voice: "“It's not funny anymore. It's just a bad movie that people won't stop talking about.”" },
    ],
    symbols: ["plastic spoons", "the rooftop", "the football", "the tuxedo", "the framed picture of a spoon"],
    pos: { x: 0.90, y: 0.10 },
  },
  {
    slug: "showgirls-1995",
    ...
    reading:
      "Showgirls is the most successful 'failed' film in the history of the studio system. Initially treated as a career-ending disaster, it has undergone a massive Reclamation Arc. Current critical discourse reads it as a savage, intentional satire of American capitalism rather than an accidental camp classic. Its Formal Risk is actually quite high — it uses the aesthetic of a big-budget musical to deliver a deeply ugly, transgressive critique. Its high Voltage comes from its aggressive, unlikable energy.",
    metrics: {
      consensus: 55,
      friction: 89,
      obsession: 76,
    ...
    notes: {
      friction: "The war between 'it's a secret masterpiece' and 'it's a misogynistic wreck' is still active.",
      symbolic: "High score due to recent academic work linking it to Verhoeven's other satirical works like RoboCop.",
      transgression: "The rape scene and the general hostility of the film create a high score that complicates its camp status.",
    },
    afterlife: [
      { year: 1995, kind: "release", label: "Critical evisceration; wins a record number of Razzies." },
      { year: 1996, kind: "reissue", label: "Becomes a massive hit on the home video market for ironic viewing." },
      { year: 2010, kind: "rediscovery", label: "Major critics begin to defend it as a serious satire." },
      { year: 2020, kind: "academic", label: "Documentary You Don't Nomi explores its complex legacy." },
    ],
    factions: [
      { name: "The Satirists", share: 0.45, voice: "“Verhoeven knew exactly what he was doing; it's a brilliant, garish mirror of the American Dream.”" },
      { name: "The Camp Counselors", share: 0.40, voice: "“It's just incredibly fun to quote. It's the best bad movie ever made.”" },
      { name: "The Detractors", share: 0.15, voice: "“Calling it satire is a reach. It's just a loud, mean-spirited, poorly acted film.”" },
    ],
    symbols: ["brown rice", "the pool", "the nipple clamps", "the golden nails", "the staircase"],
    pos: { x: 0.75, y: 0.40 },
  },
  {
    ...
    runtime: 93,
    catalogue: "new-line-cinema",
    epigraph: "Filth is my politics! Filth is my life!",
    reading:
      "Pink Flamingos is the bedrock of Transgression. It was designed as a direct assault on the sensibilities of the American middle class. Unlike The Room, its badness is a weaponized aesthetic. It scores maximum points for Cult Formation because it created its own universe — the Dreamlanders. Its legacy is stable; everyone agrees on what it is and what it did. Its Residual Haunting is physiological, specifically tied to the final scene, which functions as a cultural dare that has never been surpassed.",
    metrics: {
      consensus: 91,
      friction: 30,
      obsession: 68,
    ...
    notes: {
      transgression: "The definitive 100. It is the benchmark against which all other cinematic filth is measured.",
      progeny: "High score due to its massive influence on punk aesthetic, drag culture, and independent film.",
      accessibility: "Low, not because it's hard to follow, but because most bodies will reject it within 10 minutes.",
    },
    afterlife: [
      { year: 1972, kind: "release", label: "Underground sensation at the Elgin Theater; defines the Midnight Movie." },
      { year: 1980, kind: "academic", label: "John Waters becomes a mainstream cult figure; the film enters the canon of trash." },
      { year: 2021, kind: "criterion", label: "Inducted into the National Film Registry and Criterion, completing the Filth to Fine Art arc." },
    ],
    factions: [
      { name: "The Filth Followers", share: 0.60, voice: "“Divine is the ultimate movie star. This is a joyful, disgusting celebration of being an outsider.”" },
      { name: "The Academics", share: 0.30, voice: "“A radical queer text that uses the grotesque to dismantle power structures.”" },
      { name: "The Nauseated", share: 0.10, voice: "“I don't care about the subtext; I can't believe I watched that ending.”" },
    ],
    symbols: ["the trailer", "the singing anus", "the dog", "the red dress", "the cardboard meat"],
    pos: { x: 0.50, y: 0.99 },
  },
...

  {
    ...
    runtime: 105,
    catalogue: "columbia-pictures",
    epigraph: "We're ready to believe you!",
    reading:
      "Ghostbusters is a rare Stable Object that has recently been destabilized by its own legacy. For decades, it was the gold standard of the High Concept comedy — a perfect alignment of snark and spectacle. However, the mention density has spiked in recent years due to the Friction surrounding its sequels and reboots. It has moved from a communal childhood memory to a frontline in the culture wars, causing its Friction score to rise as various factions fight over who owns the brand's soul.",
    metrics: {
      consensus: 78,
      friction: 74,
      obsession: 82,
    ...
    notes: {
      friction: "The high score isn't about the 1984 film itself, but the Interpretive War regarding the franchise's direction.",
      accessibility: "Near-ceiling. A perfect entry-point film requiring zero cultural glossary.",
      progeny: "Massive. It defined the supernatural procedural and the modern action-comedy template.",
    },
    afterlife: [
      { year: 1984, kind: "release", label: "Global box office phenomenon; defines the 80s blockbuster." },
      { year: 1986, kind: "meme", label: "The Real Ghostbusters cartoon cements the brand in the toy-aisle consciousness." },
      { year: 2016, kind: "wound", label: "The reboot triggers a massive, toxic discourse event that recontextualizes the original." },
      { year: 2021, kind: "reissue", label: "Legacy sequels shift the tone from snarky comedy to sacred mythology." },
    ],
    factions: [
      { name: "The Purists", share: 0.50, voice: "“A perfect, lightning-in-a-bottle comedy that should have been left alone.”" },
      { name: "The Lore-Keepers", share: 0.35, voice: "“It's a foundational American myth; we need to respect the rules of the equipment and the ghosts.”" },
      { name: "The Revisionists", share: 0.15, voice: "“It's a film about four small-business owners fighting government overreach. It's more neoliberal than you remember.”" },
    ],
    symbols: ["the proton pack", "the Stay Puft Marshmallow Man", "green slime", "the firehouse", "the Ecto-1"],
    pos: { x: 0.85, y: 0.20 },
  },
  {
    slug: "revenge-of-the-nerds-1984",
    title: "Revenge of the Nerds",
    year: 1984,
    director: "Jeff Kanew",
    runtime: 90,
    catalogue: "20th-century-studios",
    epigraph: "No one's gonna be laughing at us anymore.",
    reading:
      "Revenge of the Nerds is currently undergoing a massive Negative Arc. Once celebrated as a triumphant underdog story that predicted the rise of the Tech-Billionaire class, it is now frequently cited as a wound or a transgression. The mention volume is dominated by post-release Friction regarding its treatment of consent and race. It is a film that has effectively lost its Consensus; what was once Standard Comedy is now analyzed as Historical Trauma, making it a primary case study in how cultural shifts can turn a hero into a villain.",
    metrics: {
      consensus: 25,
      friction: 92,
      obsession: 48,
    ...
    notes: {
      consensus: "Extremely low. There is no longer a shared account of whether this film is a victory or a horror movie.",
      transgression: "The score has skyrocketed retrospectively due to the masking scene, which is now read as a felony.",
      arc: "Measures the distance between the 1984 classic and the 2026 problematic status.",
    },
    afterlife: [
      { year: 1984, kind: "release", label: "Major success; spawns three sequels and defines the campus comedy." },
      { year: 2005, kind: "meme", label: "The Nerd archetype becomes the dominant force in the global economy." },
      { year: 2014, kind: "wound", label: "Think-piece culture begins to systematically dismantle the film's consent issues." },
      { year: 2020, kind: "rejection", label: "Significant removal from Best Of lists and streaming rotation." },
    ],
    factions: [
      { name: "The Nostalgics", share: 0.30, voice: "“It's just an 80s movie; stop applying today's morals to yesterday's jokes.”" },
      { name: "The Modern Critics", share: 0.55, voice: "“The film isn't about nerds winning; it's about the birth of toxic entitlement.”" },
      { name: "The Cultural Historians", share: 0.15, voice: "“A fascinating artifact of a time when victimhood was used to justify any behavior.”" },
    ],
    symbols: ["pocket protectors", "the synthesizer", "the Darth Vader mask", "the tricycle", "the pie eating contest"],
    pos: { x: 0.70, y: 0.30 },
  },
  {
    ...
    runtime: 116,
    catalogue: "universal-pictures",
    epigraph: "Roads? Where we're going, we don't need roads.",
    reading:
      "Back to the Future is the Golden Ratio of American screenwriting. It maintains a near-perfect Consensus — it is almost universally regarded as a flawless machine. Its Obsession score is high not because of controversy, but because of its Dense System; fans treat the timeline as a puzzle to be solved. It has a high Residual Haunting in the form of Temporal Nostalgia — the film installed a specific, idealized version of the 1950s into the global psyche that persists even for those who never lived it. It is the definitive Time Travel text.",
    metrics: {
      consensus: 95,
      friction: 12,
      obsession: 89,
    ...
    notes: {
      accessibility: "Perfect 100. The film explains its own complex internal logic seamlessly while moving at high speed.",
      arc: "Very low. The film's standing has remained virtually unchanged since the day it was released.",
      symbolic: "High score due to the Oedipal subtext and the precision of its setup-and-payoff structure.",
    },
    afterlife: [
      { year: 1985, kind: "release", label: "Number one film of the year; turns the DeLorean into a global icon." },
      { year: 2015, kind: "meme", label: "Back to the Future Day (October 21) becomes a real-world global event." },
      { year: 2020, kind: "academic", label: "Cited by screenwriting programs worldwide as the perfect script." },
      { year: 2023, kind: "reissue", label: "Successful musical adaptation proves the IP's durability across mediums." },
    ],
    factions: [
      { name: "The Structuralists", share: 0.60, voice: "“There isn't a wasted frame or line of dialogue in the entire movie.”" },
      { name: "The Chrono-Nerds", share: 0.30, voice: "“I've spent 20 years mapping the Twin Pines/Lone Pine shift. It's a perfect loop.”" },
      { name: "The Skeptics", share: 0.10, voice: "“Can we talk about the fact that Marty literally invented Rock n' Roll for Chuck Berry?”" },
    ],
    symbols: ["the DeLorean", "the Flux Capacitor", "the clock tower", "the hoverboard", "the Save the Clock Tower flyer"],
    pos: { x: 0.95, y: 0.05 },
  },
...

  {
    ...
    runtime: 136,
    catalogue: "warner-bros-archive",
    epigraph: "No one can be told what the Matrix is. You have to see it for yourself.",
    reading:
      "The Matrix is the foundational text of the 21st-century simulation-anxiety complex. Its cultural position has undergone a radical transformation: initially a high-fashion action blockbuster, it has been metabolized into a universal metaphor for political and social awakening. Its Progeny score is massive, influencing everything from cinematic bullet time to the very language of online radicalization. It holds a high Symbolic Density because it remains a primary site for trans-allegorical readings and philosophical debate about the nature of reality.",
    metrics: {
      consensus: 92,
      friction: 68,
      obsession: 95,
    ...
    notes: {
      progeny: "The ceiling. It fundamentally changed the visual grammar of action cinema and the thematic preoccupations of science fiction for two decades.",
      friction: "Recent years have seen high friction regarding the Red Pill metaphor being co-opted by various political factions.",
      symbolic: "High density due to its layers of Baudrillardian philosophy, religious iconography, and the Wachowskis' own retrospective context.",
    },
    afterlife: [
      { year: 1999, kind: "release", label: "A surprise cultural explosion that defines the turn of the millennium." },
      { year: 2003, kind: "rejection", label: "The sequels create a wave of disappointment, though they are later reappraised as ambitious failures." },
      { year: 2012, kind: "academic", label: "Becomes a standard text for Gender Studies and Post-Humanist theory." },
      { year: 2021, kind: "meme", label: "The Red Pill enters the global lexicon as a permanent and contested political shorthand." },
    ],
    factions: [
      { name: "The Allegorists", share: 0.45, voice: "“It's a profound trans narrative about shedding a false identity and seeing the truth.”" },
      { name: "The Technologists", share: 0.35, voice: "“A chillingly accurate prediction of our transition into a digital, simulated existence.”" },
      { name: "The Action Purists", share: 0.20, voice: "“Forget the philosophy; it's just the greatest kung-fu movie Hollywood ever produced.”" },
    ],
    symbols: ["the red pill", "the green rain", "the black trench coat", "the ringing phone", "the white rabbit"],
    pos: { x: 0.98, y: 0.60 },
  },
  {
    slug: "inception-2010",
    ...
    runtime: 148,
    catalogue: "ARTX-037",
    epigraph: "What is the most resilient parasite? An idea.",
    reading:
      "Inception represents the Industrialization of the Puzzle Film. It is the work that convinced the mainstream audience that complexity was a form of entertainment. Its high Obsession score is driven by the Top — a single image that sustained a decade of forum debate. While its Formal Risk is moderate (it is a very polished, loud studio film), its Symbolic Density is high because it invites the viewer to map its nested architectures. It has become the linguistic shorthand for any layered or meta experience in modern culture.",
    metrics: {
      consensus: 85,
      friction: 35,
      obsession: 92,
    ...
    notes: {
      obsession: "Driven by the Final Shot discourse and the meticulous tracking of the film's rules (totems, kicks, etc.).",
      accessibility: "High for a film this complex; Nolan uses exposition as a rhythmic device to keep the audience on board.",
      progeny: "Visible in the 'Bwaaaa' sound design of nearly every trailer for a decade.",
    },
    afterlife: [
      { year: 2010, kind: "release", label: "Massive box office; hailed as a thinking man's blockbuster." },
      { year: 2014, kind: "meme", label: "The suffix '-ception' is added to the dictionary of internet slang." },
      { year: 2020, kind: "academic", label: "Frequent comparisons to Borgesian labyrinths and architectural theory." },
    ],
    factions: [
      { name: "The Mechanics", share: 0.55, voice: "“It's a perfect clockwork machine. If you watch it enough, every level of the dream makes sense.”" },
      { name: "The Emotionalists", share: 0.25, voice: "“The spinning top is a distraction; the movie is actually a tragedy about a man who can't let go of his wife.”" },
      { name: "The Skeptics", share: 0.20, voice: "“It's a very loud movie about people explaining things to each other in hallways.”" },
    ],
    symbols: ["the spinning top", "the hotel hallway", "the freight train", "the chess piece", "the snow fortress"],
    pos: { x: 0.82, y: 0.45 },
  },
  {
    slug: "under-the-silver-lake-2018",
    title: "Under the Silver Lake",
    year: 2018,
    director: "David Robert Mitchell",
    runtime: 139,
    catalogue: "a24",
    epigraph: "Beware the dog killer.",
    reading:
      "Under the Silver Lake is the Inception for the paranoid internet era. Initially dumped by its distributor and dismissed as an aimless mess, it has developed one of the most intense Cult Formations of the 21st century. It is a film built entirely of Symbolic Density — codes, hidden messages, and pop-culture debris. Its Obsession score is near-maximal because its fans actually believe the film contains a real-world puzzle to be solved. It represents the Arc of a film that was born dead and became a digital religion.",
    metrics: {
      consensus: 32,
      friction: 78,
      obsession: 99,
    ...
    notes: {
      symbolic: "The ceiling. The film is a literal map of hidden ciphers, many of which were only solved years later by Reddit communities.",
      obsession: "Measured by the frame-by-frame analysis common in its dedicated subcultures.",
      arc: "The journey from unwatchable flop to misunderstood masterpiece was unusually rapid.",
    },
    afterlife: [
      { year: 2018, kind: "release", label: "Cannes premiere is met with confusion; the US release is delayed and then buried." },
      { year: 2019, kind: "rediscovery", label: "A dedicated subreddit forms to crack the codes hidden in the background of scenes." },
      { year: 2024, kind: "academic", label: "Ranked as a definitive Neo-Noir and a prophetic look at Los Angeles as a hollow myth." },
    ],
    factions: [
      { name: "The Code-Breakers", share: 0.50, voice: "“The film is a puzzle box. If you find the right cipher in the cereal box, the whole thing unlocks.”" },
      { name: "The Cinephiles", share: 0.30, voice: "“A brilliant, shaggy-dog story about the way pop culture rots the brain.”" },
      { name: "The Dismissive", share: 0.20, voice: "“It's a self-indulgent hipster odyssey that goes nowhere and means nothing.”" },
    ],
    symbols: ["the Nintendo Power magazine", "the owl woman", "the balloon girl", "the hobo code", "the Hollywood sign"],
    pos: { x: 0.40, y: 0.15 },
  },
  {
    ...
    reading:
      "Interstellar is the Sentimental Labyrinth. It achieves a unique cultural position by merging hard science with high Emotional Voltage. Its mention density is sustained by the Tesseract sequence — a visual attempt to render the fifth dimension that has become a benchmark for Cosmic Awe. While it has high Consensus as a technical marvel, Friction exists regarding its love-transcends-dimensions climax. It is an obsessed-over object for both amateur physicists and those seeking a cathartic, tear-soaked experience.",
    metrics: {
      consensus: 76,
      friction: 42,
      obsession: 88,
    ...
    notes: {
      voltage: "Scores exceptionally high due to the Hans Zimmer factor and the physiological impact of the docking sequence.",
      symbolic: "High density due to the integration of Kip Thorne's black hole equations into the visual narrative.",
      haunting: "The Mountain Wave and the Tesseract are frequently cited as recurring dream-images for viewers.",
    },
    afterlife: [
      { year: 2014, kind: "release", label: "Global success; a rare example of Original IP dominating the box office." },
      { year: 2019, kind: "academic", label: "The first black hole visualization (Gargantua) confirmed by real-world Event Horizon Telescope data." },
      { year: 2024, kind: "reissue", label: "10-year IMAX re-release breaks records, confirming its status as a Modern Classic." },
    ],
    factions: [
      { name: "The Sentimentalists", share: 0.45, voice: "“The physics are just the frame; the movie is a heartbreaking story about a father and a daughter.”" },
      { name: "The Hard-SF Purists", share: 0.35, voice: "“The most accurate depiction of time-dilation ever filmed. It makes the vastness of space feel terrifying.”" },
      { name: "The Logic-Testers", share: 0.20, voice: "“The Love speech is a bit much. It tries to solve a math problem with a feeling.”" },
    ],
    symbols: ["the watch", "the cornfield", "the bookshelf", "Gargantua", "the dust storm"],
    pos: { x: 0.88, y: 0.75 },
  },
  {
    slug: "enemy",
    ...
    reading:
      "Enemy is a claustrophobic Psychological Puzzle. It operates on a high level of Symbolic Density, specifically regarding the Jungian Shadow and totalitarian imagery. Its cultural footprint is almost entirely defined by its final frame — a shocking visual transgression that triggered a massive explanatory ecosystem on the web. It is a film of low Accessibility but high Obsession; it is designed to be watched twice and then discussed for years. It marks Villeneuve's transition from Thriller Director to Philosophical Architect.",
    metrics: {
      consensus: 48,
      friction: 55,
      obsession: 84,
    ...
    notes: {
      haunting: "The Final Shot is one of the highest-rated Intrusive Memory events in the entire database.",
      symbolic: "Every frame — the spiders, the yellow hue, the keys — is analyzed as a recursive system of masculine anxiety.",
      accessibility: "Penalized for its refusal to explain its surrealist elements, requiring a glossary of dream logic.",
    },
    afterlife: [
      { year: 2013, kind: "release", label: "Small theatrical run; becomes a word-of-mouth WTF sensation on streaming." },
      { year: 2016, kind: "academic", label: "Primary text for studies on the Double in contemporary cinema." },
      { year: 2021, kind: "meme", label: "The ending becomes a permanent fixture in Top 10 Craziest Endings video-essays." },
    ],
    factions: [
      { name: "The Decoders", share: 0.55, voice: "“The spiders aren't real; they represent the subconscious fear of commitment and entrapment.”" },
      { name: "The Visceralists", share: 0.25, voice: "“I don't care what it means; the tone is so oppressive it made me feel like I was choking.”" },
      { name: "The Skeptics", share: 0.20, voice: "“A very stylish student film that thinks its metaphors are deeper than they are.”" },
    ],
    symbols: ["the spider", "the blueberry", "the key", "the double", "the yellow haze"],
    pos: { x: 0.15, y: 0.60 },
  },
  {
    slug: "nightmare-on-elm-street-1984",
    ...
    reading:
      "A Nightmare on Elm Street is a Slasher that breached the walls of Surrealism. It holds a massive score for Residual Haunting because it weaponized the one space no viewer can avoid: sleep. Its cultural life is dual-layered: it is a populist 80s monster movie (High Accessibility) and a sophisticated Recursive Labyrinth (High Symbolic Density). The film's Friction has increased as modern critics re-evaluate its subtext regarding suburban rot and generational trauma. It remains the progenitor of the Dream-Logic horror subgenre.",
    metrics: {
      consensus: 82,
      friction: 38,
      obsession: 75,
    ...
    notes: {
      haunting: "Near-ceiling. Freddy Krueger is a Memetic Virus that successfully invaded the literal dreams of a generation.",
      formal: "High risk for its time — blurring the line between dream and reality without visual cues like wavy lines or color shifts.",
      progeny: "Massive influence on Meta-Horror and any work exploring the intersection of consciousness and physical threat.",
    },
    afterlife: [
      { year: 1984, kind: "release", label: "Instant classic; saves New Line Cinema from bankruptcy." },
      { year: 1991, kind: "meme", label: "Freddy becomes a Pop Icon, diluting the horror with puns and merchandising." },
      { year: 2010, kind: "rejection", label: "The remake is rejected, causing a critical reappraisal of Craven's original surrealist vision." },
      { year: 2022, kind: "academic", label: "Becomes a focus for Sleep Science and Liminal Space theory in film studies." },
    ],
    factions: [
      { name: "The Horror Fans", share: 0.50, voice: "“The perfect slasher; it's scary, imaginative, and has the best final girl in Nancy.”" },
      { name: "The Psychoanalysts", share: 0.35, voice: "“Freddy is the personification of the sins of the parents coming back to haunt the children.”" },
      { name: "The Formalists", share: 0.15, voice: "“Craven's use of practical effects to create impossible spaces is still the gold standard.”" },
    ],
    symbols: ["the striped sweater", "the glove", "the boiler room", "the telephone", "the white streak of hair"],
    pos: { x: 0.65, y: 0.80 },
  },
...

  {
    ...
    runtime: 121,
    catalogue: "ARTX-024",
    epigraph: "When I die, bury me deep, lay two speakers at my feet.",
    reading:
      "Mandy is a maximalist Heavy Metal fever dream that successfully bridges the gap between Arthouse Surrealism and Grindhouse Revenge. Its cultural life is fueled by Cage-Mania but sustained by its unique Formal Risk: a first half that moves like a funeral dirge and a second half that moves like a chainsaw. It has high Residual Haunting due to its Cheddar Goblin aesthetics and its saturated, chromatic visual language. It is a cornerstone of the Modern Psychotronic canon.",
    metrics: {
      consensus: 74,
      friction: 38,
      obsession: 81,
    ...
    notes: {
      voltage: "Maximum physiological impact through color theory and sound design; the bathroom scream is a high-voltage anchor.",
      cult: "High score reflecting the rapid formation of a dedicated aesthetic subculture around Cosmatos.",
      formal: "The refusal of standard pacing in the first hour is a significant formal risk that paid off with its core audience.",
    },
    afterlife: [
      { year: 2018, kind: "release", label: "Sundance premiere; immediately hailed as the ultimate Nic Cage performance." },
      { year: 2019, kind: "meme", label: "The Cheddar Goblin and the Chainsaw Duel become permanent internet shorthand." },
      { year: 2022, kind: "academic", label: "Studied for its Haptic Visuality and use of 1980s texture as a narrative device." },
    ],
    factions: [
      { name: "The Aesthetes", share: 0.50, voice: "“It's a moving painting; a tragic, beautiful elegy for a lost love disguised as a gore-fest.”" },
      { name: "The Cage-Connoisseurs", share: 0.35, voice: "“The purest distillation of Cage-Rage ever captured on celluloid.”" },
      { name: "The Impatient", share: 0.15, voice: "“Too slow, too loud, and too much style over substance. I don't get the hype.”" },
    ],
    symbols: ["the custom axe", "the tiger shirt", "Cheddar Goblin", "the black skulls", "the blood-red sky"],
    pos: { x: 0.20, y: 0.90 },
  },
  {
    slug: "first-reformed",
    ...
    runtime: 113,
    catalogue: "ARTX-029",
    epigraph: "Can God forgive us for what we've done to this world?",
    reading:
      "First Reformed is a Theological Pressure Cooker that revived the Transcendental Style for the climate-anxiety era. Its cultural position is defined by Sustained Dread; it is the film most frequently cited by scrapers when discussing the intersection of faith and environmental collapse. Its Friction score is centered on its Ambiguous Ending — a formal rupture that forced the audience into an interpretive war. It has high Symbolic Density, acting as a dialogue between Schrader and his own cinematic lineage (Bresson, Ozu).",
    metrics: {
      consensus: 82,
      friction: 54,
      obsession: 72,
    ...
    notes: {
      formal: "The 4:3 aspect ratio and still-camera approach are aggressive formal choices that heighten the internal tension.",
      symbolic: "High density due to the layers of Christian iconography and the levitation sequence.",
      haunting: "The image of Pepto-Bismol mixed with whiskey is an indelible Ugly Memory for viewers.",
    },
    afterlife: [
      { year: 2017, kind: "release", label: "Venice premiere; hailed as Schrader's late-career masterpiece." },
      { year: 2018, kind: "academic", label: "Becomes a primary text for Eco-Theology and the study of Slow Cinema." },
      { year: 2023, kind: "rediscovery", label: "Ranks high in Best of the Century polls for its prescient look at radicalization." },
    ],
    factions: [
      { name: "The Existentialists", share: 0.60, voice: "“The most honest depiction of despair ever filmed. It's a prayer that goes unanswered.”" },
      { name: "The Politicals", share: 0.25, voice: "“It perfectly captures the moment when environmental grief turns into inevitable radicalization.”" },
      { name: "The Skeptics", share: 0.15, voice: "“The ending is a fantasy that doesn't earn the preceding 100 minutes of realism.”" },
    ],
    symbols: ["the barbed wire", "Pepto-Bismol", "the bicycle", "the journal", "the levitation"],
    pos: { x: 0.05, y: 0.45 },
  },
  {
    slug: "saint-maud",
    ...
    reading:
      "Saint Maud is a Somatic Horror that uses the body as a site of religious mania. It functions as a modern companion to First Reformed but with a higher Haunting score due to its final, literal one-second flash of reality. Its cultural life is characterized by Unease; it is discussed as a film that installs a sense of spiritual vertigo. Its Accessibility is relatively high for an arthouse horror, but its Formal Risk remains high due to its subjective, increasingly fractured POV.",
    metrics: {
      consensus: 76,
      friction: 41,
      obsession: 62,
    ...
    notes: {
      haunting: "The final shot is a Memetic Wound — short, sharp, and impossible to forget.",
      voltage: "High score for the physical portrayal of Ecstasy vs. Pain.",
      transgression: "The self-mortification scenes (thumbtacks in shoes) provide a high physiological current.",
    },
    afterlife: [
      { year: 2019, kind: "release", label: "TIFF premiere; A24 acquisition cements its Prestige Horror status." },
      { year: 2021, kind: "academic", label: "Studied for its portrayal of Female Religious Delusion and the Gaze." },
      { year: 2025, kind: "rediscovery", label: "Continuously cited as the definitive arthouse horror debut of the decade." },
    ],
    factions: [
      { name: "The Horror Fans", share: 0.40, voice: "“A slow-burn masterpiece with the most terrifying final second in history.”" },
      { name: "The Psychologists", share: 0.40, voice: "“It's a perfect study of isolation, trauma, and the way the mind uses religion as a shield.”" },
      { name: "The Religious", share: 0.20, voice: "“An uncomfortable look at the thin line between a saint and a patient.”" },
    ],
    symbols: ["the thumbtacks", "the popcorn", "the angel wings", "the boiling soup", "the beach"],
    pos: { x: 0.18, y: 0.72 },
  },
  {
    slug: "the-northman",
    ...
    runtime: 137,
    catalogue: "ARTX-027",
    epigraph: "I will save you, mother. I will kill you, Fjölnir. I will avenge you, father.",
    reading:
      "The Northman is a Hyper-Autopsy of the revenge myth. It represents a massive Formal Risk — a studio-funded $90 million attempt to create an uncompromising, period-accurate hallucination. Its cultural footprint is characterized by high Friction between those who read it as a macho action epic and those who see it as a deconstruction of toxic heritage. Its Residual Haunting is high due to its mud-and-blood tactility; viewers report a physical exhaustion after viewing, scoring it highly on the Physiological current of the Voltage axis.",
    metrics: {
      consensus: 62,
      friction: 58,
      obsession: 74,
    ...
    notes: {
      formal: "The commitment to long, unbroken takes and historically reconstructed lighting is a high-risk endeavor for a film of this scale.",
      voltage: "Peaked during the Volcano Duel; the language in scrapers is almost entirely physiological (sweat, heat, heart-rate).",
      symbolic: "High density due to the integration of Old Norse mythology and the Amleth-Hamlet recursive loop.",
    },
    afterlife: [
      { year: 2022, kind: "release", label: "Initial box office disappointment leads to rapid Cult Formation on VOD." },
      { year: 2023, kind: "meme", label: "The Viking Barking and Berserker sequences proliferate as a subcultural aesthetic." },
      { year: 2025, kind: "academic", label: "Cited as the definitive work of Folk-Horror Realism." },
    ],
    factions: [
      { name: "The Eggers Aesthetes", share: 0.45, voice: "“A miraculous, uncompromising vision that makes every other historical epic look like a theme park.”" },
      { name: "The Skeptics", share: 0.30, voice: "“It's just Hamlet with more dirt and yelling. Too self-serious to be fun.”" },
      { name: "The Mythologists", share: 0.25, voice: "“Finally, a film that treats ancient belief systems as a lived reality rather than a metaphor.”" },
    ],
    symbols: ["the valkyrie's braces", "the night-raven", "the volcano", "the silver tree", "the severed head"],
    pos: { x: 0.45, y: 0.85 },
  },
  {
    ...
    runtime: 114,
    catalogue: "ARTX-039",
    epigraph: "I just don't like you no more.",
    reading:
      "Banshees is a Micro-Breakdown with macro-implications. It is a film of extreme Friction, not because of its quality, but because of its central conflict: a dispute so petty yet so absolute it feels like a cosmic error. Its Symbolic Density is high, serving as an allegory for the Irish Civil War and the banality of despair. It has a high Residual Haunting score specifically tied to the shears — an intrusive memory of self-mutilation that disrupts its Cozy Arthouse surface. It is a work of high Obsession for those who track its dialogue as a recursive rhythm.",
    metrics: {
      consensus: 88,
      friction: 65,
      obsession: 79,
    ...
    notes: {
      friction: "The central mystery of 'Why?' remains an open interpretation war: is Colm a genius or just a cruel man?",
      transgression: "High score for the visceral nature of the finger-throwing as a violation of social and bodily norms.",
      accessibility: "High; the premise is simple and the humor provides a low barrier to entry.",
    },
    afterlife: [
      { year: 2022, kind: "release", label: "Major critical success; dominates the Best of Year discourse." },
      { year: 2023, kind: "meme", label: "The Jenny the Donkey and 'I'm not nice?' quotes become ubiquitous in social commentary." },
      { year: 2024, kind: "academic", label: "Becomes a primary text for studying Existential Male Loneliness in the 2020s." },
    ],
    factions: [
      { name: "The Pádraic Sympathizers", share: 0.50, voice: "“A heartbreaking look at how the world punishes simple kindness and niceness.”" },
      { name: "The Colm Defenders", share: 0.30, voice: "“It's about the terrifying necessity of art and the need to leave a legacy, no matter the cost.”" },
      { name: "The Allegorists", share: 0.20, voice: "“It's not about two men; it's about the irrational, self-destructive nature of civil war.”" },
    ],
    symbols: ["the shears", "the miniature donkey", "the pint of stout", "the rainbow", "the fire"],
    pos: { x: 0.60, y: 0.40 },
  },
  {
    ...
    runtime: 139,
    catalogue: "sony-pictures",
    epigraph: "What if this is as good as it gets?",
    reading:
      "As Good as It Gets is a Fossilized Breakdown. In 1997, it was the peak of Consensus — a beloved, Oscar-winning romantic comedy. Today, its Arc is trending downward as modern scrapers re-evaluate the Transgression of its central character's behavior. It holds a unique Friction score: it is a film that is increasingly difficult to watch for younger audiences, yet remains a Comfort Object for older demographics. Its Obsession score is driven by the technical brilliance of Nicholson's performance, now studied as a Historical Type of the Difficult White Male trope.",
    metrics: {
      consensus: 45,
      friction: 82,
      obsession: 55,
    ...
    notes: {
      arc: "Massive distance between its 90s Heartwarming status and the 20s Problematic reading.",
      transgression: "The character's racism, homophobia, and misogyny — originally framed as quirks — now register as high-voltage transgressions.",
      accessibility: "Very high; it follows the traditional Hollywood beats perfectly.",
    },
    afterlife: [
      { year: 1997, kind: "release", label: "Critical and commercial juggernaut; wins Best Actor and Best Actress." },
      { year: 2015, kind: "rejection", label: "Start of the 'Can we still watch this?' think-piece wave." },
      { year: 2024, kind: "academic", label: "Used as a case study for the Evolution of the Protagonist and mental health representation." },
    ],
    factions: [
      { name: "The Traditionalists", share: 0.40, voice: "“A witty, classic character study. They don't make adult dramedies like this anymore.”" },
      { name: "The Modern Skeptics", share: 0.45, voice: "“It's an exhausting apology for a terrible man. Why are we supposed to want them together?”" },
      { name: "The Nicholson Loyalists", share: 0.15, voice: "“Whatever you think of the writing, the performance is a masterclass in timing and charisma.”" },
    ],
    symbols: ["the dog in the laundry chute", "the plastic utensils", "the sidewalk cracks", "the bacon", "the pills"],
    pos: { x: 0.80, y: 0.25 },
  },

  // ── The Kinetic & The Primal ──────────────────────────────────────────────

  {
    ...
    runtime: 120,
    catalogue: "ARTX-033",
    epigraph: "My world is fire and blood.",
    reading:
      "Fury Road is a Pure Kinetic masterpiece that achieved an almost impossible level of Consensus upon release. It is the rare Action Sequel that functions as high-art Formal Risk — a two-hour chase scene that delivers more characterization through movement than most films do through dialogue. Its Symbolic Density is high, specifically regarding its feminist subtext and environmental collapse. It is an obsessed-over object for its practical effects and its Visual Grammar, which returned the Spectacle to the hands of the formalists.",
    metrics: {
      consensus: 96,
      friction: 15,
      obsession: 94,
    ...
    notes: {
      voltage: "The ceiling. A masterclass in physiological engagement; the War Boys and Doof Warrior elements create a sustained adrenaline spike.",
      formal: "Maximized score for its Center-Frame editing philosophy and the rejection of CGI-heavy aesthetics in favor of practical stunts.",
      progeny: "Directly influenced the Legacy Sequel boom and redefined the visual vocabulary of the post-apocalypse.",
    },
    afterlife: [
      { year: 2015, kind: "release", label: "Cannes premiere stuns critics; becomes the best-reviewed action film of the century." },
      { year: 2016, kind: "academic", label: "Becomes a primary text for Eco-Feminism and Pure Cinema theory." },
      { year: 2024, kind: "reissue", label: "Furiosa prequel fuels a massive retrospective Black & Chrome re-release." },
    ],
    factions: [
      { name: "The Pure Cinema Purists", share: 0.60, voice: "“A miracle. It tells its entire story through the eyes and the gas pedal. This is what movies are for.”" },
      { name: "The Allegorists", share: 0.30, voice: "“It's not just a car chase; it's a profound dismantling of patriarchy and resource hoarding.”" },
      { name: "The Stunt-Obsessed", share: 0.10, voice: "“I've watched the making-of more than the movie. The physical risk on screen is palpable.”" },
    ],
    symbols: ["the silver spray paint", "the guitar-man", "the steering wheel", "the green place", "the prosthetic arm"],
    pos: { x: 1.00, y: 0.95 },
  },
  {
    slug: "mad-max-1979",
    ...
    runtime: 88,
    catalogue: "ARTX-036",
    epigraph: "The Interceptor is the last of the V8s.",
    reading:
      "The 1979 original is a Guerilla Artifact with a massive Arc score. It began as a low-budget Australian exploitation film and transformed into the blueprint for the Desolate Future genre. Its Formal Risk was high for its time — using real speed and dangerous stunts that bordered on the Transgressive. Its Obsession score is fueled by its Origin Story status; it captures a society in the exact moment of breaking, rather than after the fall. It remains a benchmark for Ozploitation and the Revenge-Thriller arc.",
    metrics: {
      consensus: 84,
      friction: 28,
      obsession: 72,
    ...
    notes: {
      progeny: "The entire Post-Apocalyptic aesthetic of the last 40 years can be traced back to this film's leather and dust.",
      arc: "The journey from a B-movie to a National Treasure of Australia and global cinema history.",
      transgression: "High for its era due to the Toecutter violence and the nihilistic ending.",
    },
    afterlife: [
      { year: 1979, kind: "release", label: "Major hit in Australia; dubbed into American English for US release — a minor wound." },
      { year: 1985, kind: "meme", label: "The Road Warrior persona enters the global pop-culture lexicon." },
      { year: 2020, kind: "reissue", label: "4K restoration highlights the Guerilla cinematography and raw speed." },
    ],
    factions: [
      { name: "The Genre Fans", share: 0.55, voice: "“The leanest, meanest revenge movie ever made. It's raw and it hurts.”" },
      { name: "The Historians", share: 0.30, voice: "“A fascinating look at Pre-Apocalypse — the specific social anxiety of the 1970s oil crisis.”" },
      { name: "The Stunt Nerds", share: 0.15, voice: "“The bike stunts are terrifying because they were real. You can feel the asphalt.”" },
    ],
    symbols: ["the Interceptor", "the leather jacket", "the sawed-off shotgun", "the badge", "the road bridge"],
    pos: { x: 0.70, y: 0.75 },
  },
];
